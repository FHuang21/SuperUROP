...
args.num_heads = 4; args.num_classes = 1; args.dropout = 0.0; args.kernel_size=3; args.stride=1
args.pe_learned = False; args.device = torch.device('cpu')
...
##more weight:
# model_path = "/data/scratch/alimirz/2023/SIMON/TENSORBOARD/AUTOMATIC_TUNING/exp_lr_0.002_w_1.0,5_ds_eeg_bs_16_epochs_15_dpt_0.0_fold0_256,64,16_heads4_08-22-23_fixedpe_PHASE2-TUNE2-fc3_BCE_PEamp_1/lr_0.002_w_1.0,5_bs_16_heads4_0.0_att08-22-23_fixedpe_PHASE2-TUNE2-fc3_BCE_epochs15_fold0.pt"
model_path = "/data/scratch/alimirz/2023/SIMON/TENSORBOARD/CONV_MODEL/exp_lr_0.0002_w_1.0,1.0_ds_eeg_bs_64_epochs_15_dpt_0.3_fold0_256,64,16_heads4_08-25-23_nofc1_decay2e-4_512256128_attn_flipped_PEamp_1_Model_bottleneckmodel_kernelsize_3/lr_0.0002_w_1.0,1.0_bs_64_heads4_0.3_att08-25-23_nofc1_decay2e-4_512256128_attn_flipped_epochs15_fold0.pt"
...
plt.savefig(os.path.join(figure_savepath,"convmodel_training_TUNE2_antidep_shhs_CDF.pdf"))