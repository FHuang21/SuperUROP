...
class Flow_Attention(nn.Module):
    ...
    # added to visualize the attention
    def forward_with_visualization(self, queries, keys, values):
        # print("inside Flow_Attention")
        ...
        return x, normalizer_col_refine
...
class AttentionLayer(nn.Module):
    ...
    def forward_with_visualization(self, queries, keys, values):
        ...
        out, att = self.inner_attention.forward_with_visualization(
            queries,
            keys,
            values
        )
